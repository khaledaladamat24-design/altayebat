  ...
  return (
    ...
    >
      <motion.div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 50% 50%, white 2px, transparent 0)",
      ...
      >
        ...
        <motion.h1
          ...
          animate={
            phase >= 1 ? { scale: 1, opacity: 1 } : { scale: 0.8, opacity: 0 }
          }
        ...
        >
          <div className="bg-black text-white rounded-xl py-3 px-6 flex items-center justify-center gap-3 shadow-xl border border-gray-800">
            <svg viewBox="0 0 512 512" className="w-7 h-7">
              <path
                fill="#00D2FF"
                d="M48 59.5v393c0 4.3 2.3 8.1 5.8 10.2L276 256 53.8 49.3C50.3 51.4 48 55.2 48 59.5z"
              />
              <path
                fill="#00E676"
                d="M345 174L91.7 33.7C84 29.4 75 30 68.4 34.3L276 256 345 174z"
              />
              <path
                fill="#FFC400"
                d="M464 256c0-9.6-5.1-18.5-13.4-23.3L385.5 196 304 256l81.5 60 65.1-36.7C458.9 274.5 464 265.6 464 256z"
              />
              <path
                fill="#FF3D00"
                d="M68.4 477.7C75 482 84 482.6 91.7 478.3L345 338l-69-82L68.4 477.7z"
              />
            </svg>
          ...
          <p className="text-white font-bold text-[5vw] mt-2">
            حمّل التطبيق الآن
          </p>
        </motion.div>
      </div>

        ...
        <div className="flex-1 flex items-center justify-center relative">
          ...
          <AnimatePresence mode="wait">
            ...
            {phase >= 3 && (
              <FeatureCard
                key="f3"
                title="مجاني للمطاعم بدون عمولات أو تعقيدات"
                align="right"
                y="20vh"
              />
            )}
...
function FeatureCard({
  ...
  return (
    ...
    >
      <p className="text-primary font-bold text-lg m-0 text-center max-w-[44vw] leading-snug">
        {title}
      </p>
    </motion.div>
  );

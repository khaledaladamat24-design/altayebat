...
export default function Categories() {
  ...
  const [zone] = useState<Zone>(() => {
    ...
    return saved === "regular" || saved === "grocery" ? saved : "healthy";
  });
    ...
    <div className="pb-8" dir={dir}>
      <div className="bg-primary text-primary-foreground pt-12 pb-6 px-4 rounded-b-3xl shadow-sm relative z-10 flex items-center gap-4">
        ...
        <h1 className="text-xl font-bold flex-1">
          {zone === "regular"
            ? tr("أقسام المتنوع", "Diverse Categories")
            : zone === "grocery"
              ? tr("أقسام البقالة", "Grocery Categories")
      ...
      <div className="px-4 mt-6">
        <div className="grid grid-cols-2 gap-4">
          {isLoading
            ...
            : categories?.map((cat) => {
                const name =
                  lang === "en" ? cat.name || cat.nameAr : cat.nameAr;
                return (

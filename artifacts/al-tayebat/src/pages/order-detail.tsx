            ...
            <div className="space-y-3 text-sm">
              {track.providerName && (
                <div>
                  <span className="text-muted-foreground block text-xs mb-1">
                    {tr("شركة التوصيل", "Delivery company")}
                  </span>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(track.trackingNumber!);
                      toast.success(
                        tr("تم نسخ رقم التتبع", "Tracking number copied"),
                      );
                    }}
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {track.awbUrl && (
                  ...
                  >
                    ...
                    {tr("بوليصة الشحن (AWB)", "Airway bill (AWB)")}
                  </a>
                )}
                {track.providerPhone && (
                  <a
                    href={`tel:${track.providerPhone}`}

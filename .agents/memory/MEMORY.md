...
- [Auth unified form](auth-unified-form.md) — al-tayebat login/signup is ONE phone-or-email field; UI shell derives email/phone and dispatches to unchanged Clerk/Firebase handlers.
